        ...
        <div className="space-y-6 p-6">
          <section>
            ...
            <p className="mb-4 text-sm text-muted-foreground">
              Required for natural language → SQL. Use a free OpenRouter key from{' '}
              <a
              ...
              (model: llama-3.3-70b-versatile), or an Anthropic key from{' '}
              <a
            ...
            <form onSubmit={handleSave} className="space-y-3">
                <input
                  ...
                  placeholder="sk-or-... or gsk_... or sk-ant-..."
